		...
		<>
			<nav className='container d-flex justify-content-between my-4'>
				...
				<div className='nav-left d-flex gap-2 align-items-center'>
					...
					<Link to='/'>
						<div className='nav-container shadow-sm p-3' style={{ borderRadius: '36px', backgroundColor: 'white' }}>
				...
				<div className='nav-right'>
					<Link to='/'>
						<div className='nav-container shadow-sm p-2 d-flex align-items-center gap-2' style={{ borderRadius: '36px', backgroundColor: 'white' }}>
